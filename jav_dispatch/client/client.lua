...
RegisterNetEvent("jav_dispatch:alertToClient")
AddEventHandler("jav_dispatch:alertToClient", function(text, coords, id)
...
RegisterNetEvent("jav_dispatch:vehToClient")
AddEventHandler("jav_dispatch:vehToClient", function(coords, model, color, id)
    if PlayerData.job and PlayerData.job.name == 'police' and activated then
        callnum = callnum + 1
        totalcalls = totalcalls + 1
        local distanceToAlert = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), coords)
...
RegisterCommand("auxilio", function(source, args)
    ...
    TriggerServerEvent("jav_dispatch:sendAmbuAlert", text, coords, id)
end, false)
...
RegisterCommand("meca", function(source, args)
    ...
    local coords = GetEntityCoords(PlayerPedId())
    local id = GetPlayerServerId(PlayerId())
    TriggerServerEvent("jav_dispatch:sendMecaAlert", text, coords, id)
end, false)
...
RegisterCommand("pedirtaxi", function(source, args)
    ...
    local coords = GetEntityCoords(PlayerPedId())
    local id = GetPlayerServerId(PlayerId())
    TriggerServerEvent("jav_dispatch:sendTaxiaAlert", text, coords, id)
end, false)

RegisterNetEvent("jav_dispatch:auxToClient")
AddEventHandler("jav_dispatch:auxToClient", function(text, coords, id)
...
RegisterNetEvent("jav_dispatch:taxiToClient")
AddEventHandler("jav_dispatch:taxiToClient", function(text, coords, id)
...
RegisterNetEvent("jav_dispatch:mecaToClient")
AddEventHandler("jav_dispatch:mecaToClient", function(text, coords, id)
...
RegisterNetEvent("jav_dispatch:robberyToClient")
AddEventHandler("jav_dispatch:robberyToClient", function(type, coords, id)
    if PlayerData.job and PlayerData.job.name == 'police' and activated then
        callnum = callnum + 1
        totalcalls = totalcalls + 1
...
RegisterCommand("forzar", function()
    ...
    if IsPedInAnyVehicle(ped, false) then
        ...
        TriggerServerEvent("jav_dispatch:sendVehRob", coords, model, finalColor, id)
    end
end, false)
...
RegisterCommand("entorno", function(source, args)
    ...
    local coords = GetEntityCoords(PlayerPedId())
    local id = GetPlayerServerId(PlayerId())
    TriggerServerEvent("jav_dispatch:sendAlert", text, coords, id)
end, false)
